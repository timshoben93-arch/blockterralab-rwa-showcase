...
export const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-surface-dark">
      ...
      <div className="container relative pt-14 pb-20 sm:pt-20 sm:pb-28 md:pt-28 md:pb-36">
        <div className="mx-auto max-w-5xl text-center animate-fade-in-up">
          ...
          <h1 className="mt-8 font-display font-bold tracking-tight text-3xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.05] text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)]">
      ...
      <div className="container pb-14 sm:pb-20">
        <div className="rounded-3xl bg-surface-dark text-surface-dark-foreground py-6 px-5 sm:px-8 shadow-elevated">
          <div className="flex flex-wrap items-center justify-center md:justify-between gap-x-6 sm:gap-x-12 gap-y-4 opacity-90">
            ...
            {["Helix Capital", "Terra Yield", "OnChain RE", "Aurum DAO", "Stratum Labs", "Veridian"].map((n) => (
              <span key={n} className="font-display font-semibold text-sm sm:text-base md:text-lg tracking-tight">
                {n}
              </span>
            ))}
          </div>
